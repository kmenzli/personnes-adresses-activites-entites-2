...
public class Main {
	...
	// constantes
	private final static String TABLE_PERSONNE_ACTIVITE = "jpa08_hb_personne_activite";

	private final static String TABLE_PERSONNE = "jpa08_hb_personne";

	private final static String TABLE_ACTIVITE = "jpa08_hb_activite";

	private final static String TABLE_ADRESSE = "jpa08_hb_adresse";
	...
	public static void test1() throws ParseException {
		...
		act1.getPersonnes().add(p1);
		p1.getActivites().add(act2);
		act2.getPersonnes().add(p1);
		p2.getActivites().add(act1);
		act1.getPersonnes().add(p2);
		p2.getActivites().add(act3);
		act3.getPersonnes().add(p2);
		// d�but transaction
		EntityTransaction tx = em.getTransaction();
		tx.begin();
	...
	public static void test2() {
		...
		act1.getPersonnes().remove(p1);
		act2.getPersonnes().remove(p1);		
		// suppression personne p1
		em.remove(p1);
		// fin transaction
		tx.commit();
	...
	public static void test4() {
		...
		for (Object pa : em.createQuery("select a.nom from Activite a join a.personnes p where p.nom='p2'").getResultList()) {
	...
	public static void test5() {
		...
		System.out.format("2 - Personnes pratiquant l'activit� act3 (relation inverse) :%n");
